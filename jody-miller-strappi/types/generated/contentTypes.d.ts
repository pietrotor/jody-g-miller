...
export interface ApiArchiveItemArchiveItem extends Struct.CollectionTypeSchema {
  collectionName: 'archive_items';
  info: {
    description: "Articles, videos, and podcasts in Jody's archive";
    displayName: 'Archive Item';
    pluralName: 'archive-items';
...
export interface ApiBioBio extends Struct.SingleTypeSchema {
  collectionName: 'bios';
  info: {
    description: "Jody's biography page content";
    displayName: 'Bio';
    pluralName: 'bios';
    singularName: 'bio';
  };
...
export interface ApiBtgBtg extends Struct.SingleTypeSchema {
  collectionName: 'btg_pages';
  info: {
    description: 'Business Talent Group page content';
    displayName: 'BTG';
    pluralName: 'btg-pages';
    singularName: 'btg';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categories for filtering archive items';
  ...
  attributes: {
    archiveItems: Schema.Attribute.Relation<
      'oneToMany',
      'api::archive-item.archive-item'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiSpeakingSpeaking extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Speaking and advisory page content';
    displayName: 'Speaking';
    pluralName: 'speaking-pages';
...
export interface ApiTheDetailsTheDetails extends Struct.SingleTypeSchema {
  collectionName: 'the_details';
  info: {
    description: 'Experience narrative sections for the About page';
    displayName: 'The Details';
    pluralName: 'the-details-pages';
    singularName: 'the-details';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    boards: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entrepreneurial: Schema.Attribute.RichText;
    executive: Schema.Attribute.RichText;
    government: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    nonprofit: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::archive-item.archive-item': ApiArchiveItemArchiveItem;
